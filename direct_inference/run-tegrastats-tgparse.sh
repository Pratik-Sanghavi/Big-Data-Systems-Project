...
if [ "$#" -ne 3 ]; then
	        echo "Usage: ./run-tegrastats-tgparse.sh <interval_in_milliseconds> <total_count> <output>"
		            exit 1
		    fi
		    ...
		    for (( i=1; i<=$total_count; i++ ))
			        do
						...
						# Parse log file and output results and csv file
						/home/cs744/adap/venv/bin/python /home/cs744/adap/tgparse.py output-stats.txt -o $output_file -i $interval
						echo "Finished executing $total_count posts and parsed logfile to $output_file"
